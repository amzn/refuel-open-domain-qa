...
class MyBart_QAGen(BartForConditionalGeneration):
    def forward(self, input_ids, attention_mask=None, encoder_outputs=None,
            decoder_input_ids=None, decoder_attention_mask=None, decoder_cached_states=None,
            lm_labels=None, use_cache=False, is_training=False, decoder_start_token_id=None):
        if is_training:
            ...
            y_ids[..., 0] = decoder_start_token_id
